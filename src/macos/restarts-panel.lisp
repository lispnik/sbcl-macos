;;;; src/macos/restarts-panel.lisp -- the restarts as an NSPanel.
;;;;
;;;; The Mac's half of src/restarts.lisp, which explains the design: the
;;;; condition, the frames and the restarts in a floating panel, whose buttons
;;;; TYPE the chosen restart's number for you.  This file is the AppKit: the
;;;; panel, its table and its data source, and Escape in the listener window.
